        ...
        <nav className="border-t border-zinc-200 bg-white flex justify-center">
            <ul className="mx-auto max-w-7xl flex gap-8 py-3">
                {categories.map((category) => (
                    <li key={category.id}>
                        <Link href={`/products/${category.slug}`} className="group flex items-center gap-2 text-sm font-medium text-sm font-medium text-zinc-700 hover:text-black transition">
